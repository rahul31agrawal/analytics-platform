...
from superset.abinitio_security_manager import AbinitioSecurityManager
...
PRINT_PDF_SERVICE = os.path.join(BASE_DIR, "static", "assets", "print_pdf")
...
def env_variable_override(env_var_name, config_dict):
    if os.environ.get(env_var_name):
        conf_str = os.environ.get(env_var_name)
        try:
            config_override = json.loads(conf_str)
            for conf_key in config_override:
                config_dict[conf_key] = config_override[conf_key]
        except Exception:
            logging.exception("Failed reading {} json env variable".format(env_var_name))
...
CUSTOM_SECURITY_MANAGER = AbinitioSecurityManager
#CUSTOM_SECURITY_MANAGER = None
if os.environ.get("NO_CUSTOM_SECURITY_MANAGER"):
    CUSTOM_SECURITY_MANAGER = None
...
# SQLALCHEMY_DATABASE_URI = "sqlite:///" + os.path.join(DATA_DIR, "superset_test_iou.db")
# SQLALCHEMY_DATABASE_URI = 'mysql://myapp@localhost/myapp'
SQLALCHEMY_DATABASE_URI = 'postgresql://postgres:postgres@localhost/superset_db3'
if os.environ.get("SUPERSET_DB_URI"):
    SQLALCHEMY_DATABASE_URI = os.environ.get("SUPERSET_DB_URI")

SQLALCHEMY_BINDS = {'iou': 'postgresql://postgres:postgres@localhost:5432/iou2'}
if os.environ.get("IOU_DB_URI"):
    SQLALCHEMY_BINDS = {'iou': os.environ.get("IOU_DB_URI")}
...
APP_ICON = "/static/assets/images/iou_logo.png"
APP_ICON_WIDTH = 126
...
CACHE_DEFAULT_TIMEOUT = 60 * 15     # 15 minutes
CACHE_CONFIG = {'CACHE_TYPE': 'simple',
                'CACHE_DEFAULT_TIMEOUT': CACHE_DEFAULT_TIMEOUT,
                }
TABLE_NAMES_CACHE_CONFIG = {"CACHE_TYPE": "null"}

env_variable_override('CACHE_CONFIG', CACHE_CONFIG)
...
#CHART TO PDF OPTIONS: numeric limit of columns in a dataframe that will decide the page standard for A4 to A3
CHART_TO_PDF_COLUMN_LIMIT_A3 = 7
...
DEFAULT_MODULE_DS_MAP = OrderedDict(
    [
        ...
        #("superset.connectors.iou.models", ["IouTable"])
    ]
)
...
AUDIT_LOGGING_PATH = os.environ.get("AUDIT_LOGS_LOCATION", DATA_DIR ) + "/audit_logs.log"
...
ABINITIO_GATEWAY_CONFIG = {
    "host": "66.42.50.28",
    "port": "53501",
    "root_path": "/ag/",
    "get_user_roles_path": "apm/getUserInfo.do",
    "publish_roles_path": "apm/publishConfig.do",
    "register_product_path": "apm/getProduct.do",
    "use_ssl": False,
    "ssl_cert_ignore_ca": False,
    "product_name": "IOU Core",
    "api_user": "ani",
    "api_password": "skuad@123",
    "role_mapping": {"1": "Admin"}
  }

env_variable_override('ABINITIO_GATEWAY_CONFIG', ABINITIO_GATEWAY_CONFIG)
