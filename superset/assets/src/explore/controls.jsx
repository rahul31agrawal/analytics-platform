...
export const controls = {
  ...
  y_axis_2_bounds: {
    ...
    renderTrigger: true,
    default: [null, null],
    description: t('Bounds for the Y-axis 2. When left empty, the bounds are ' +
    'dynamically defined based on the min/max of the data. Note that ' +
    "this feature will only expand the axis range. It won't " +
    "narrow the data's extent."),
  },
  ...
  dashed_line: {
    ...metric,
    label: t('Select which metrics to be displayed as dashed line'),
    clearable: true,
    default: "",
    validators: [],
    description: t('Choose a metrics for dashed line'),
  },

  bars: {
    ...metrics,
    label: t('Select which metrics to be bars'),
    clearable: true,
    validators: [],
    default: [],
    description: t('Choose a metrics for bars'),
  },
  ...
  x_axis_label: {
    ...
    renderTrigger: true,
    default: null,
    description: t('Label for X Axis'),
  },
  ...
  y_axis_label: {
    ...
    renderTrigger: true,
    default: null,
    description: t('Label for Left Y Axis'),
  },
  ...
  y_axis_2_label: {
    ...
    renderTrigger: true,
    default: null,
    description: t('Label for Right Y Axis'),
  },
  ...
  num_stacks: {
    ...
    default: 2,
    isFloat: false,
    description: t('Bars per Group, expects values between 0 and 100'),
  },
