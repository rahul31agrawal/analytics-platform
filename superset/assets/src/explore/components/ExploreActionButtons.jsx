...
export default function ExploreActionButtons({
  ...
  const doExportExcel = exportChart.bind(this, latestQueryFormData, 'xlsx');
  const doExportPdf = exportChart.bind(this, latestQueryFormData, 'pdf');
  ...
  return (
    <div className="btn-group results" role="group">
      ...
      {latestQueryFormData &&
        ...
        <a
          onClick={doExportPdf}
          className={exportToCSVClasses} //This is a front-end class
          title={t('Export to Pdf format')}
          target="_blank"
          rel="noopener noreferrer"
        >
