...
export const LOG_ACTIONS_EXPORT_EXCEL_DASHBOARD_CHART = 'export_xlsx_dashboard_chart';
export const LOG_ACTIONS_EXPORT_PDF_DASHBOARD_CHART = 'export_pdf_dashboard_chart';
