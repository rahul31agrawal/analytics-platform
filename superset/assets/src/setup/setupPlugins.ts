...
import GroupedColumnLineChart from '../explore/controlPanels/GroupedColumnLineChart';
import GroupedStackedBarChart from '../explore/controlPanels/GroupedStackedBarChart';
...
export default function setupPlugins() {
  ...
  getChartControlPanelRegistry()
    ...
    .registerValue('grouped_column_line_chart', GroupedColumnLineChart)
    .registerValue('grouped_stacked_bar_chart', GroupedStackedBarChart);
