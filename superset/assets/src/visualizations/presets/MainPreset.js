...
import GroupedColumnLineChart from '@superset-ui/legacy-plugin-grouped-column-line-chart';
import GroupedStackedBarChart from '@superset-ui/legacy-plugin-grouped-stacked-bar-chart';
  ...
  constructor() {
    super({
      ...
      plugins: [
        ...
        new GroupedColumnLineChart().configure({ key: 'grouped_column_line_chart' }),
        new GroupedStackedBarChart().configure({ key: 'grouped_stacked_bar_chart'})
      ],
    });
  }
}
